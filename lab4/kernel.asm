...
80106d0d:	ba f4 54 11 80       	mov    $0x801154f4,%edx
80106d12:	8b 30                	mov    (%eax),%esi
	//Case 1
	for (i = 0; i< 64; i++) {
80106d14:	31 c0                	xor    %eax,%eax
	uint va = PGROUNDUP(myproc()->sz);
80106d16:	81 c6 ff 0f 00 00    	add    $0xfff,%esi
80106d1c:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
80106d22:	eb 0f                	jmp    80106d33 <shm_open+0x43>
80106d24:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
	for (i = 0; i< 64; i++) {
80106d28:	83 c0 01             	add    $0x1,%eax
80106d2b:	83 c2 0c             	add    $0xc,%edx
80106d2e:	83 f8 40             	cmp    $0x40,%eax
80106d31:	74 6d                	je     80106da0 <shm_open+0xb0>
		if(shm_table.shm_pages[i].id == id) {
80106d33:	3b 1a                	cmp    (%edx),%ebx
80106d35:	75 f1                	jne    80106d28 <shm_open+0x38>
			pa = V2P(shm_table.shm_pages[i].frame);
80106d37:	8d 1c 40             	lea    (%eax,%eax,2),%ebx
80106d3a:	c1 e3 02             	shl    $0x2,%ebx
80106d3d:	8b 83 f8 54 11 80    	mov    -0x7feeab08(%ebx),%eax
80106d43:	8d b8 00 00 00 80    	lea    -0x80000000(%eax),%edi
			mappages(myproc()->pgdir, (void*) va, PGSIZE, pa, PTE_W|PTE_U);
80106d49:	e8 62 c9 ff ff       	call   801036b0 <myproc>
80106d4e:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106d55:	00 
80106d56:	89 7c 24 0c          	mov    %edi,0xc(%esp)
80106d5a:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106d61:	00 
80106d62:	89 74 24 04          	mov    %esi,0x4(%esp)
80106d66:	8b 40 04             	mov    0x4(%eax),%eax
80106d69:	89 04 24             	mov    %eax,(%esp)
80106d6c:	e8 df f7 ff ff       	call   80106550 <mappages>
			shm_table.shm_pages[i].refcnt++;
80106d71:	83 83 fc 54 11 80 01 	addl   $0x1,-0x7feeab04(%ebx)
...
80106d7b:	89 30                	mov    %esi,(%eax)
			myproc()->sz += PGSIZE;
80106d7d:	e8 2e c9 ff ff       	call   801036b0 <myproc>
80106d82:	81 00 00 10 00 00    	addl   $0x1000,(%eax)
			release(&(shm_table.lock));
80106d88:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106d8f:	e8 ac d4 ff ff       	call   80104240 <release>
	}
...
80106d94:	83 c4 2c             	add    $0x2c,%esp
80106d97:	31 c0                	xor    %eax,%eax
80106d99:	5b                   	pop    %ebx
80106d9a:	5e                   	pop    %esi
80106d9b:	5f                   	pop    %edi
80106d9c:	5d                   	pop    %ebp
...
80106d9e:	66 90                	xchg   %ax,%ax
	for (i = 0; i< 64; i++) {
80106da0:	ba f4 54 11 80       	mov    $0x801154f4,%edx
80106da5:	30 c0                	xor    %al,%al
80106da7:	eb 12                	jmp    80106dbb <shm_open+0xcb>
80106da9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
	for (i = 0; i < 64; i++) {
80106db0:	83 c0 01             	add    $0x1,%eax
80106db3:	83 c2 0c             	add    $0xc,%edx
80106db6:	83 f8 40             	cmp    $0x40,%eax
80106db9:	74 78                	je     80106e33 <shm_open+0x143>
		if(shm_table.shm_pages[i].id == 0) {
80106dbb:	8b 0a                	mov    (%edx),%ecx
80106dbd:	85 c9                	test   %ecx,%ecx
80106dbf:	75 ef                	jne    80106db0 <shm_open+0xc0>
			shm_table.shm_pages[i].id = id;
80106dc1:	8d 3c 40             	lea    (%eax,%eax,2),%edi
80106dc4:	c1 e7 02             	shl    $0x2,%edi
80106dc7:	89 9f f4 54 11 80    	mov    %ebx,-0x7feeab0c(%edi)
			shm_table.shm_pages[i].refcnt = 1;
80106dcd:	c7 87 fc 54 11 80 01 	movl   $0x1,-0x7feeab04(%edi)
80106dd4:	00 00 00 
			shm_table.shm_pages[i].frame = kalloc();
80106dd7:	e8 d4 b6 ff ff       	call   801024b0 <kalloc>
			memset(shm_table.shm_pages[i].frame, 0, PGSIZE);
80106ddc:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106de3:	00 
80106de4:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106deb:	00 
80106dec:	89 04 24             	mov    %eax,(%esp)
			shm_table.shm_pages[i].frame = kalloc();
80106def:	89 87 f8 54 11 80    	mov    %eax,-0x7feeab08(%edi)
			memset(shm_table.shm_pages[i].frame, 0, PGSIZE);
80106df5:	e8 96 d4 ff ff       	call   80104290 <memset>
			pa = V2P(shm_table.shm_pages[i].frame);
80106dfa:	8b 9f f8 54 11 80    	mov    -0x7feeab08(%edi),%ebx
			mappages(myproc()->pgdir, (void*) va, PGSIZE, pa, PTE_W|PTE_U);
80106e00:	e8 ab c8 ff ff       	call   801036b0 <myproc>
80106e05:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106e0c:	00 
80106e0d:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106e14:	00 
			pa = V2P(shm_table.shm_pages[i].frame);
80106e15:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
			mappages(myproc()->pgdir, (void*) va, PGSIZE, pa, PTE_W|PTE_U);
80106e1b:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
80106e1f:	89 74 24 04          	mov    %esi,0x4(%esp)
80106e23:	8b 40 04             	mov    0x4(%eax),%eax
80106e26:	89 04 24             	mov    %eax,(%esp)
80106e29:	e8 22 f7 ff ff       	call   80106550 <mappages>
80106e2e:	e9 45 ff ff ff       	jmp    80106d78 <shm_open+0x88>
	release(&(shm_table.lock));
80106e33:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106e3a:	e8 01 d4 ff ff       	call   80104240 <release>
	return 0;
80106e3f:	e9 50 ff ff ff       	jmp    80106d94 <shm_open+0xa4>
...
80106e66:	b8 f4 54 11 80       	mov    $0x801154f4,%eax
	int i;
	for (i = 0; i< 64; i++) {
80106e6b:	31 d2                	xor    %edx,%edx
80106e6d:	eb 0c                	jmp    80106e7b <shm_close+0x2b>
80106e6f:	90                   	nop
80106e70:	83 c2 01             	add    $0x1,%edx
80106e73:	83 c0 0c             	add    $0xc,%eax
80106e76:	83 fa 40             	cmp    $0x40,%edx
80106e79:	74 4d                	je     80106ec8 <shm_close+0x78>
		if(shm_table.shm_pages[i].id == id) {
80106e7b:	39 18                	cmp    %ebx,(%eax)
80106e7d:	75 f1                	jne    80106e70 <shm_close+0x20>
			if(shm_table.shm_pages[i].refcnt >= 1) {
80106e7f:	8b 48 08             	mov    0x8(%eax),%ecx
80106e82:	85 c9                	test   %ecx,%ecx
80106e84:	7e 0a                	jle    80106e90 <shm_close+0x40>
				shm_table.shm_pages[i].refcnt--;
80106e86:	83 e9 01             	sub    $0x1,%ecx
			}
			if(shm_table.shm_pages[i].refcnt <= 0) {	 
80106e89:	85 c9                	test   %ecx,%ecx
				shm_table.shm_pages[i].refcnt--;
80106e8b:	89 48 08             	mov    %ecx,0x8(%eax)
			if(shm_table.shm_pages[i].refcnt <= 0) {	 
80106e8e:	75 e0                	jne    80106e70 <shm_close+0x20>
				shm_table.shm_pages[i].id = 0;
80106e90:	8d 04 52             	lea    (%edx,%edx,2),%eax
80106e93:	c1 e0 02             	shl    $0x2,%eax
				shm_table.shm_pages[i].frame = 0;
				shm_table.shm_pages[i].refcnt = 0;
				release(&(shm_table.lock));
80106e96:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
				shm_table.shm_pages[i].id = 0;
80106e9d:	c7 80 f4 54 11 80 00 	movl   $0x0,-0x7feeab0c(%eax)
80106ea4:	00 00 00 
				shm_table.shm_pages[i].frame = 0;
80106ea7:	c7 80 f8 54 11 80 00 	movl   $0x0,-0x7feeab08(%eax)
80106eae:	00 00 00 
				shm_table.shm_pages[i].refcnt = 0;
80106eb1:	c7 80 fc 54 11 80 00 	movl   $0x0,-0x7feeab04(%eax)
80106eb8:	00 00 00 
				release(&(shm_table.lock));
80106ebb:	e8 80 d3 ff ff       	call   80104240 <release>
			}
		}
	}
	release(&(shm_table.lock));
...
80106ec0:	83 c4 14             	add    $0x14,%esp
80106ec3:	31 c0                	xor    %eax,%eax
80106ec5:	5b                   	pop    %ebx
80106ec6:	5d                   	pop    %ebp
80106ec7:	c3                   	ret    
	release(&(shm_table.lock));
80106ec8:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106ecf:	e8 6c d3 ff ff       	call   80104240 <release>
}
80106ed4:	83 c4 14             	add    $0x14,%esp
80106ed7:	31 c0                	xor    %eax,%eax
80106ed9:	5b                   	pop    %ebx
80106eda:	5d                   	pop    %ebp
80106edb:	c3                   	ret    
